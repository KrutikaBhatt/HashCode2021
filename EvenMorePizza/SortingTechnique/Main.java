...
public class Main {
	...
	public static void main(String[] args) {
		...
		String path = "C:\\Users\\User\\Desktop\\hashcode - Google\\Techniques\\MinMax\\"+filenames[3];
		String output = "C:\\Users\\User\\Desktop\\hashcode - Google\\Techniques\\MinMax\\"+"d_many_pizzas.out";
		
		MinPlusMax minmax = new MinPlusMax();
		Dataset dataset = load_dataset(path);
		
		long startTime = System.nanoTime();
		ArrayList<Order> orders = minmax.create_order(dataset);
		generatOutput(output,orders);
		
		long endTime   = System.nanoTime();
		long totalTime = endTime - startTime;
		System.out.println("The Total time in Grid Technique");
		System.out.println("In "+filenames[0]+" :"+totalTime);
